...
public class Purchase {
    ...
    public static Map<String,String> path(){
        ...
        path.put("purchase", "datafile/biz/purchase.csv");// 本地的数据文件
        path.put("input", HDFS + "/exp/data/zookeeper/purchase");// HDFS的目录
        path.put("output", HDFS + "/exp/result/zookeeper/purchase/"); // 输出目录
        return path;
    }
