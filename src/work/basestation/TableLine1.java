 ...
 * 定义异常类
 */
class LineException1 extends Exception
{
	private static final long serialVersionUID = 8245008693589452584L;
	int flag;
	public LineException1(String msg, int flag)
	{
		super(msg);
		this.flag = flag;
	}
...
public class TableLine1
{
	 ...
	 * 初始化并检查该行的合法性
	 */  
	public void set ( String line, boolean source, String date, String [] timepoint ) throws LineException1
	{
