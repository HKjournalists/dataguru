 ...
 */  
public class BaseStation2 extends Configured implements Tool 
{
	/**  
	 * 计数器
	 * 用于计数各种异常数据
	...
	public static class Reduce extends Reducer<Text, Text, NullWritable, Text> 
	{
		...
		{
			String imsi = key.toString().split("\\|")[0];//imsi
			...
			for ( Text value : values )
			{
				...
				try 
				{
					uploads.put( Long.valueOf( valueString.split("\\|")[1] ), valueString.split("\\|")[0] );//CGI、时间
				}
...
//	              maps.put(st.position, st.stayTime);
//	      }
//	      return maps;
//      }
	...
	public int run(String[] args) throws Exception {
		...
		Job job = new Job(conf, "BaseStation2");
	...
	public static void main(String[] args) throws Exception 
	{
		...
		//运行任务
		int res = ToolRunner.run(new Configuration(), new BaseStation2(), args);
