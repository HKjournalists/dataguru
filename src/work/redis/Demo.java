...
public class Demo {   
    ...
    public void test1(){
        Jedis  redis = new Jedis ("192.168.142.133",6379);//连接redis   
       ...
       System.out.println("Hash操作");
        ...
        List list11 = redis.hmget("website","google","baidu","sina");  
        ...
        List list111 = redis.lrange("list", 0, -1);  
