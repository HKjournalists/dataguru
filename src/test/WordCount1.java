...
public class WordCount1 {
   ...
   * it receives each new line in the input files as an input to the mapper. The Òmap?function 
   ...
   * <li>As an optional step, copy the Òinput?directory to the top level of the IDE based project (eclipse project) that you created for samples. Now you can run 
   * the WordCount class directly from your IDE passing Òinput output?as arguments. This will run the sample same as before. Running MapReduce Jobs from IDE in this manner is very useful 
