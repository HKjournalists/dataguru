...
public class Exercise_1 extends Configured implements Tool {	
	...
	public int run(String[] args) throws Exception 
	{
		...
		Job job = new Job(conf, "Exercise_1");						
		job.setJarByClass(Exercise_1.class);					
		...
		System.out.println( "得到计数器" + job.getCounters().findCounter("org.apache.hadoop.mapred.Task$Counter", "MAP_INPUT_RECORDS").getValue() );
		System.out.println( "得到计数器" + job.getCounters().findCounter("org.apache.hadoop.mapred.Task$Counter", "MAP_OUTPUT_RECORDS").getValue() );
	...
	public static void main(String[] args) throws Exception 
	{
		...
		System.out.println( "时长" + String.valueOf( time ) + "时长" ); 
